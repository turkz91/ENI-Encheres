...
<jsp:include page='../partials/head.jsp'>
	<jsp:param name="extraCSS"
		value='<%=request.getContextPath() + "/css/inscription.css"%>' />
...
<body>
	...
	<main class="py-3">
		...
		<h1 class="text-center h3 mb-4">Information Compte - ${ !empty sessionScope.user.pseudo ? sessionScope.user.pseudo : '' }
		</h1>
		<%
		...
		%>
		<p class="text-center text-danger">Erreur, l'utilisateur n'a pas
			pu être ajouté :</p>
		<%
		...
		<div class="container eni-compteAction">
			<form action="<%=request.getContextPath()%>/compte" method="post">
				<div class="form-row align-items-center justify-content-center mb-3">
					...
					<label for="nom"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg">Nom
						: </label>
					<div class="col-6 col-md-4 col-lg-3">
				...
				<div class="form-row align-items-center justify-content-center mb-3">
					<label for="prenom"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg">Prénom
						: </label>
					<div class="col-6 col-md-4 col-lg-3">
					...
					<div class="d-none d-md-block col-lg-1"></div>
					<label for="email"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg">Email
						: </label>
					<div class="col-6 col-md-4 col-lg-3">
				...
				<div class="form-row align-items-center justify-content-center mb-3">
					<label for="telephone"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg">Téléphone
						: </label>
					<div class="col-6 col-md-4 col-lg-3">
					...
					<div class="d-none d-md-block col-lg-1"></div>
					<label for="rue"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg">Rue
						: </label>
					<div class="col-6 col-md-4 col-lg-3">
				...
				<div class="form-row align-items-center justify-content-center mb-3">
					<label for="code-postal"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg">Code
						Postal : </label>
					<div class="col-6 col-md-4 col-lg-3">
					...
					<div class="d-none d-md-block col-lg-1"></div>
					<label for="ville"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg">Ville
						: </label>
					<div class="col-6 col-md-4 col-lg-3">
				...
				<div class="form-row align-items-center justify-content-center mb-3">
					<label for="ancien-mot-de-passe"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg eni-mdp-label">Mot
						de passe actuel:</label>
					<div class="col-6 col-md-4 col-lg-3">
						<input type="password" id="ancien-mot-de-passe"
							name="ancien-mot-de-passe" class="form-control">
					</div>
					<div class="w-100 d-block d-md-none"></div>
					<div class="d-none d-md-block col-lg-1"></div>
				...
				<div class="form-row align-items-center justify-content-center mb-3">
					<label for="mot-de-passe"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg eni-mdp-label">Nouveau
						mot de passe:</label>
					<div class="col-6 col-md-4 col-lg-3">
					...
					<label for="confirmation"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg eni-mdp-label">Confirmation
						: </label>
					<div class="col-6 col-md-4 col-lg-3">
				...
				<div class="form-row align-items-center justify-content-center mb-3">
					<label for="mot-de-passe"
						class="col-5 col-sm-4 col-lg-2 col-form-label col-form-label-lg eni-mdp-label">
				...
				<div
					class="form-row align-items-center justify-content-center eni-form-footer pb-5 pt-4">
